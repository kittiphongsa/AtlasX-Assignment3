...
export class EsriMapComponent implements OnInit, OnDestroy {
  ...
  @Output() locationLoadedEvent = new EventEmitter<CustomPoint>();
  ...
  ngOnInit() {
    ...
    this.initializeMap().then(mapView => {
      ...
      this.locationLoadedEvent.emit(new CustomPoint(this._center[0],this._center[1]));
      ...
      this.locationSub = this.locService.getLocationUpdateListener().subscribe(async (location: CustomPoint) => {
        ...
        console.log("In Subscribe",location);
